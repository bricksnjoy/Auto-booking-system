...
export default function LoginPage() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-[var(--bg)] p-4 sm:p-8">
      <div className="grid w-full max-w-5xl overflow-hidden rounded-2xl border border-[var(--border)] bg-[var(--field)] shadow-[0_20px_50px_-24px_rgba(13,27,42,0.28)] lg:grid-cols-2">
        {/* form */}
